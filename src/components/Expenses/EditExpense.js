  ...
  return (
    <Fragment>
      <tr className="clickable-row">
        <td><Button type="button" className="btn btn-info" onClick={handleShowEdit}>✏️</Button></td>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <div className="text-right">
              <Button className="btn btn-danger" onClick={(expense) => { deleteExpense(expense) }}>🗑️</Button>
            </div>
          </Form>
        </Modal.Body>
        <Modal.Footer>
